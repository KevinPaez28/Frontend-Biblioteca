...
export default async () => {
    const contenedor = document.getElementById("aprendices-contenedor"); // CONTENEDOR igual que historial
  ...
  const cargarAprendices = async (page = 1) => {
    ...
    try {
      ...
      // Ocultar spinner (igual que historial)
